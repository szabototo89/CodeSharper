...
namespace CodeSharper.Core.TextManagers
{
    ...
    {
        private class TextMarker : TextMarkerBase, IEquatable<TextMarker>
        {
            ...
            /// </summary>
            public TextMarker(TextRange textRange, ITextManager textManager)
            {
            ...
            public Boolean Equals(TextMarker other)
            {
                if (ReferenceEquals(null, other)) return false;
                if (ReferenceEquals(this, other)) return true;
                return base.Equals(other) && Equals(textRange, other.textRange) && Equals(textManager, other.textManager);
            }
            ...
            public override Int32 GetHashCode()
            {
                unchecked
                {
                    ...
                    hashCode = (hashCode * 397) ^ (textRange != null ? textRange.GetHashCode() : 0);
                    hashCode = (hashCode * 397) ^ (textManager != null ? textManager.GetHashCode() : 0);
                    return hashCode;
                }
            }
        ...
        /// <returns></returns>
        public void RemoveText(TextRange textRange)
        {
            Assume.NotNull(textRange, "textRange");
        ...
        /// </summary>
        public void ChangeText(TextRange textRange, String replacedText)
        {
            Assume.NotNull(textRange, "textRange");
        ...
        private void upgradeTextRangeStop(TextRange textRange, String replacedText)
        {
            textRange.Stop = textRange.Start + replacedText.Length;
        }

        private Int32 calculateOffset(TextRange textRange, String replacedText)
        {
        ...
        /// </summary>
        protected internal void changeRawText(TextRange textRange, String replacedText)
        {
        ...
        #region Methods of TextManager

        private TextMarker retrieveTextMarker(TextMarkerBase marker)
        {
            Assume.NotNull(marker, "marker");
            var textMarker = marker as TextMarker;
            if (textMarker == null)
                throw new NotSupportedException("Marker type is not supported.");
        ...
        /// Gets the value.
        /// </summary>
        public String GetValue(TextMarkerBase marker)
        {
            var textMarker = retrieveTextMarker(marker);
            return GetText(textMarker.TextRange);
        }

        /// <summary>
        /// Sets the value.
        /// </summary>
        public void SetValue(TextMarkerBase marker, String value)
        {
            var textMarker = retrieveTextMarker(marker);
            ChangeText(textMarker.TextRange, value);
        }

        /// <summary>
        /// Creates the marker.
        /// </summary>
        public TextMarkerBase CreateMarker(Int32 start, Int32 exclusiveStop)
        {
            var textRange = CreateOrGetTextRange(start, exclusiveStop);
            return new TextMarker(textRange, this);
        }

        /// <summary>
        /// Removes the marker.
        /// </summary>
        public Boolean RemoveMarker(TextMarkerBase marker)
        {
            var textMarker = retrieveTextMarker(marker);
            removeTextRange(textMarker.TextRange);
            return true;
        }
